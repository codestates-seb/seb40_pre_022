...
const Join = () => {
  ...
  const handleChangeSign = useCallback((e)=>{
    ...
    <Layout isLeftSidebar={false}>
       <Wrapper>
        ...
        <InnerBox>
          ...
          <FormWrap>
            <form>
              <TextInput id='name' label='Display name' errorMsg='이름을 입력해 주세요.' isError={nameError} value={name} onChange={handleChangeSign} />
              <TextInput id='email' label='Email' errorMsg='이메일 형식을 맞춰주세요.' isError={emailError} value={email} onChange={handleChangeSign} />
              <TextInput id='pw'  type='password' label='Password' errorMsg='최소 8 자, 최소 하나의 문자,하나의 숫자 및 하나의 특수 문자' isError={pwError} value={pw} onChange={handleChangeSign} />
              <p>Passwords must contain at least eight characters, including at least 1 letter and 1 number.</p>
              <Button label='Sign up' type='submit' onClick={handleSignUp}>Sign up</Button>
            </form>
          </FormWrap>
          <Info>
